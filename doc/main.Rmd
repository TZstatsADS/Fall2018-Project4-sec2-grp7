...
```
```{r}
Wordsprob<-LDA_MODEL(docs) # results of all per- topic- per- word probability
```


## Applying OCR model on Detected error

```{r}
#load("../output/ground_truth_by_length.Rdata")
#unique_truth<-lapply(ground_truth_by_length,unique)
source("../lib/Candidate.R")
Candidate_best("epple",Wordsprob)
