...
OCR_performance_table["character_wise_recall","Tesseract"] <- split_char(old_intersect_vec)/split_char(ground_truth_vec)
OCR_performance_table["character_wise_precision","Tesseract"] <- split_char(old_intersect_vec)/split_char(tesseract_vec)
OCR_performance_table["character_wise_recall","Tesseract_with_postprocessing"] <- split_char(new_intersect_vec)/split_char(ground_truth_vec)
OCR_performance_table["character_wise_precision","Tesseract_with_postprocessing"] <-  split_char(new_intersect_vec)/split_char(tesseract_delete_error_vec)
